...
const {
  validateSop,
  validateTicketingSop,
  validateTicketingLink,
  validateItinerary,
} = require("../middleware/travelDeskValidators");
...
router.patch(
  "/:tripId/articles/:articleId",
  protect,
  contentController.updateArticle,
);
router.post(
  "/:tripId/articles/:articleId/request-changes",
  protect,
  contentController.requestChangesArticle,
);
router.patch(
  "/:tripId/articles/:articleId/status",
  protect,
  contentController.changeArticleStatus,
);
...
router.post(
  ...
  protect,
  validateTicketingSop,
  controller.createTicketingSop,
);
router.put(
  "/ticketing/sops/:id",
  protect,
  validateTicketingSop,
  controller.updateTicketingSop,
);
...
router.post(
  ...
  protect,
  validateTicketingLink,
  controller.createTicketingLink,
);
router.put(
  "/ticketing/links/:id",
  protect,
  validateTicketingLink,
  controller.updateTicketingLink,
);
...
router.put(
  "/questions/:id/answer",
  protect,
  controller.answerEscalatedQuestion,
);
...
router.post(
  ...
  protect,
  contentController.acknowledgeNotice,
);
