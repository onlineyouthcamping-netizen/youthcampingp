...
router.post(
  "/templates",
  authenticate,
  requirePermission("emails.manage_templates"),
...
router.get(
  ...
  authenticate,
  requirePermission("emails.view_logs"),
  logController.getBookingLogs,
);
router.get(
  "/logs/inquiry/:inquiryId",
  authenticate,
  requirePermission("emails.view_logs"),
  logController.getInquiryLogs,
);
router.get(
  "/logs/ticket/:trainTicketId",
  authenticate,
  requirePermission("emails.view_logs"),
  logController.getTicketLogs,
);
...
router.post(
  ...
  composerController.sendCustomEmail,
);
router.post(
  "/send-bulk-custom",
  authenticate,
  requirePermission("emails.send_bulk"),
  composerController.sendBulkEmails,
);
