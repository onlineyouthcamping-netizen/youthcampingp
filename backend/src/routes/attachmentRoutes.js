...
router.post(
  ...
  attachmentController.uploadBookingAttachments,
);
router.put(
  "/:id",
  upload.single("file"),
  attachmentController.replaceBookingAttachment,
);
...
router.post(
  "/send/booking/:bookingId",
  attachmentController.sendBookingAttachments,
);
