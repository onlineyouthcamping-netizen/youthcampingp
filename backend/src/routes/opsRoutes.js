...
router.post(
  "/hotels/:tripId/override",
  requirePermission("ops.manage"),
  createHotelOverride,
);
router.post(
  "/hotels/:tripId/reset-override",
  requirePermission("ops.manage"),
  resetHotelOverride,
);
...
router.post(
  "/checklists/:tripId/initialize",
  requirePermission("ops.checklist"),
  initializeChecklist,
);
router.post(
  "/checklists/complete",
...
router.post(
  "/sop-library/:id/archive",
  requirePermission("ops.manage"),
  archiveSopLibrary,
);
router.post(
  "/sop-library/:id/restore",
  requirePermission("ops.manage"),
  restoreSopLibrary,
);
...
router.post(
  "/leaders/:tripId/archive",
  requirePermission("ops.manage"),
  archiveTripLeader,
);
router.post(
  "/leaders/:tripId/restore",
  requirePermission("ops.manage"),
  restoreTripLeader,
);
