...
router.get(
  "/import/preview",
  requirePermission("vendors.import"),
  getImportPreview,
);
router.post(
  "/import/preview",
...
router.get(
  "/trips/:tripId/categories/:category",
  requirePermission("vendors.view"),
  getVendorsByTripAndCategory,
);
router.get(
  "/trips/:tripId/cities/:city",
  requirePermission("vendors.view"),
  getVendorsByTripAndCity,
);
router.get(
...
router.post(
  "/trip-mapping",
  requirePermission("vendors.trip.assign"),
  createTripVendorMapping,
);
router.post(
  "/rates",
  requirePermission("vendors.rate.manage"),
  createTripVendorRate,
);
router.put(
  "/rates/:rateId",
...
router.get(
  "/directory/analytics",
  requirePermission("vendors.view"),
  dirCtrl.getDirectoryAnalytics,
);
router.get(
  "/directory/destinations",
  requirePermission("vendors.view"),
  dirCtrl.getDirectoryDestinations,
);

// Search & options
router.get(
  "/directory/search/by-location",
  requirePermission("vendors.view"),
  dirCtrl.searchVendorsByLocation,
);
router.get(
  "/directory/trips/:tripId/options",
  requirePermission("vendors.view"),
  dirCtrl.getTripVendorOptions,
);
router.post(
  "/directory/trips/:tripId/mappings",
  requirePermission("vendors.mapping.manage"),
  dirCtrl.saveTripVendorMappings,
);

// Costing & Snapshots
router.post(
  "/directory/costing/calculate",
  requirePermission("vendors.costing.calculate"),
  dirCtrl.calculateVendorCosting,
);
router.post(
  "/directory/costing/snapshot",
  requirePermission("vendors.costing.calculate"),
  dirCtrl.createCostingSnapshot,
);

// Payments CRUD
router.get(
  "/directory/payments",
  requirePermission("vendors.payments.view"),
  dirCtrl.getVendorPayments,
);
router.post(
  "/directory/payments",
  requirePermission("vendors.payments.manage"),
  dirCtrl.createVendorPayment,
);
router.patch(
  "/directory/payments/:paymentId",
  requirePermission("vendors.payments.manage"),
  dirCtrl.updateVendorPayment,
);

// Rates CRUD
router.post(
  "/directory/:vendorId/room-rates",
  requirePermission("vendors.rates.manage"),
  dirCtrl.createDirectoryRoomRate,
);
router.post(
  "/directory/:vendorId/transport-rates",
  requirePermission("vendors.rates.manage"),
  dirCtrl.createDirectoryTransportRate,
);
router.post(
  "/directory/:vendorId/food-rates",
  requirePermission("vendors.rates.manage"),
  dirCtrl.createDirectoryFoodRate,
);
router.post(
  "/directory/:vendorId/guide-rates",
  requirePermission("vendors.rates.manage"),
  dirCtrl.createDirectoryGuideRate,
);
router.post(
  "/directory/:vendorId/misc-charges",
  requirePermission("vendors.rates.manage"),
...
router.post(
  "/:vendorId/transport-rates",
  requirePermission("vendors.rates.manage"),
  dirCtrl.createDirectoryTransportRate,
);
router.post(
  "/:vendorId/misc-charges",
  requirePermission("vendors.rates.manage"),
  dirCtrl.createDirectoryMiscCharge,
);
...
router.get(
  "/directory",
  requirePermission("vendors.view"),
  dirCtrl.getDirectoryVendors,
);
router.post(
  "/directory",
  requirePermission("vendors.create"),
  dirCtrl.createDirectoryVendor,
);
router.get(
  "/directory/:vendorId",
  requirePermission("vendors.view"),
  dirCtrl.getDirectoryVendor,
);
router.patch(
  "/directory/:vendorId",
  requirePermission("vendors.edit"),
  dirCtrl.updateDirectoryVendor,
);
router.delete(
  "/directory/:vendorId",
  requirePermission("vendors.deactivate"),
  dirCtrl.deleteDirectoryVendor,
);
...
router.post(
  "/ops/:id/activate",
  requirePermission("vendors.activate"),
  activateOpsVendor,
);
...
router.get(
  "/departures/:departureId/allocations",
  requirePermission("vendors.view"),
  getDepartureAllocations,
);
router.post(
  "/departures/:departureId/allocations",
  requirePermission("ops.vendor.allocate"),
  saveDepartureAllocations,
);
...
// ERP Vendor Contracts
router.get("/contracts/:vendorId", contractCtrl.getVendorContracts);
router.post("/contracts/:vendorId", requirePermission("vendors.rates.manage"), contractCtrl.createVendorContract);
router.delete("/contracts/:contractId", requirePermission("vendors.rates.manage"), contractCtrl.deleteVendorContract);
