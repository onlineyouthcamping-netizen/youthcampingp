...
router.get(
  "/company-documents",
  requirePermission(["company_documents.view"]),
  getCompanyDocuments,
);
router.post(
  "/company-documents",
  requirePermission(["company_documents.upload"]),
...
router.delete(
  ...
  requirePermission(["company_documents.archive"]),
  deleteCompanyDocument,
);
router.get(
  "/recurring-tasks",
  requirePermission(["recurring_tasks.view"]),
  getRecurringTasks,
);
router.post(
  "/recurring-tasks",
  requirePermission(["recurring_tasks.create"]),
  createRecurringTask,
);
router.put(
  "/recurring-tasks/:id/complete",
  requirePermission(["recurring_tasks.edit"]),
  completeRecurringTask,
);
...
router.get(
  "/customer-timeline/:id",
  requirePermission(["customers.timeline.view"]),
  getCustomerTimeline,
);
