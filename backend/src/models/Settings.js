...
const SettingsSchema = new mongoose.Schema({
  ...
  socialLinks: {
    ...
    instagram: {
      type: String,
      default: "https://instagram.com/youthcamping.online/",
    },
    twitter: { type: String, default: "" },
    youtube: {
      type: String,
      default: "https://youtube.com/channel/UC378U1Xiw7ZWCdj84FFVFtw",
    },
    linkedin: {
      type: String,
      default: "https://linkedin.com/company/youthcamping-online",
    },
  },
  logo: {
    type: String,
  ...
  organization: {
    ...
    mailingAddress: {
      type: String,
      default:
        "A - 738, Money Plant High Street, IIM Road, Ahmedabad, Gujarat 380015",
    },
  },
  seo: {
    ...
    metaDescription: {
      type: String,
      default:
        "Experience the best adventure tours and camping trips with YouthCamping.",
    },
  ...
  tripCustomFields: [
    {
      ...
      type: {
        type: String,
        enum: ["rich-text", "html", "video", "text"],
        default: "rich-text",
      },
      helpText: String,
  ...
  footer: {
    columns: [
      {
        ...
        type: {
          type: String,
          enum: ["links", "text", "contact", "social"],
          default: "links",
        },
    ...
    copyrightText: {
      type: String,
      default: "© 2026 YouthCamping. All rights reserved.",
    },
  },
  bookingForm: {
    roomSharingOptions: [
