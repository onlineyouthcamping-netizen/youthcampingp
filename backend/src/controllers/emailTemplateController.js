...
const defaultTemplates = [
  ...
  },
  {
    ...
    subject:
      "Your Booking is Under Review – {{trip.name}} | {{booking.reference}}",
    category: "Booking",
  ...
  },
  {
    ...
    subject:
      "Payment Completed Successfully – {{trip.name}} | {{booking.reference}}",
    category: "Payment",
  ...
  },
  {
    ...
    subject:
      "Your Train Ticket Details – {{trip.name}} | {{booking.reference}}",
  ...
  },
  {
    ...
    subject:
      "Important Train Ticket Update – {{trip.name}} | {{booking.reference}}",
    category: "Train Ticket",
  ...
  },
  {
    ...
    subject:
      "Your Trip Starts Soon – {{trip.name}} | Departure: {{trip.start_date}}",
    category: "Departure",
...
exports.createTemplate = async (req, res, next) => {
  try {
    const tenantId = req.user.tenantId || "default";
    const { name, subject, body, category, isActive, defaultAttachments } =
      req.body;
