...
// We replace the targetStr
const idx = content.lastIndexOf(targetStr);
if (idx !== -1) {
  content = content.substring(0, idx + targetStr.length) + dialogMarkup + content.substring(idx + targetStr.length);
  fs.writeFileSync(filePath, content, 'utf8');
  console.log("Hotel/Transport Dialog markup injected successfully!");
} else {
