  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      if (res.ok || data.success) {
        router.push(`/book/confirmation?bookingId=${bId}&tripName=${encodeURIComponent(initialParams.tripName || '')}&date=${encodeURIComponent(initialParams.date || '')}&city=${encodeURIComponent(selectedCity?.cityName || 'Delhi')}&name=${encodeURIComponent(formData.name || '')}`);
      } else {
