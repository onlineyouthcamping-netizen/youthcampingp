    ...
    <div className="bg-white min-h-screen font-montserrat pb-32">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-28 md:pt-32 pb-24">
        ...
        <div className="mb-8 md:mb-12 space-y-4">
          <motion.div
            {...pulse}
            className="w-32 h-4 bg-zinc-100 rounded-full"
          />
          <motion.div
            {...pulse}
            className="w-[60%] h-12 md:h-16 bg-zinc-100 rounded-2xl"
          />
        </div>
        ...
        <div className="w-full mb-8 md:mb-12">
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 aspect-[16/10] md:aspect-[21/9] w-full rounded-[24px] md:rounded-[40px] overflow-hidden bg-zinc-50 p-1">
            <motion.div
              {...pulse}
              className="md:col-span-2 md:row-span-2 bg-zinc-100 rounded-[20px] md:rounded-[36px]"
            />
            <motion.div
              {...pulse}
              className="hidden md:block bg-zinc-100 rounded-[20px]"
            />
            <motion.div
              {...pulse}
              className="hidden md:block bg-zinc-100 rounded-[20px]"
            ...
            <motion.div
              {...pulse}
              className="hidden md:block md:col-span-2 bg-zinc-100 rounded-[20px]"
            />
          </div>
        </div>
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-center gap-4 shrink-0">
              ...
              <div className="space-y-2">
                <motion.div
                  {...pulse}
                  className="w-16 h-3 bg-zinc-100 rounded-full"
                />
                <motion.div
                  {...pulse}
                  className="w-24 h-4 bg-zinc-100 rounded-full"
                />
              </div>
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="space-y-4">
              <motion.div
                {...pulse}
                className="w-24 h-6 bg-zinc-100 rounded-full"
              />
              <motion.div
                {...pulse}
                className="w-full h-24 bg-zinc-100 rounded-2xl"
              />
            </div>
            ...
            <div className="space-y-6">
              <motion.div
                {...pulse}
                className="w-full h-32 bg-zinc-50 rounded-[32px]"
              />
              <div className="space-y-4">
                {[1, 2, 3, 4].map((i) => (
                  <motion.div
                    key={i}
                    {...pulse}
                    className="w-full h-16 bg-zinc-100 rounded-2xl"
                  />
                ))}
              </div>
            </div>
