...
const MOCK_TRIPS: Trip[] = [
  {
    id: 'mock-1', title: 'Manali Kasol Amritsar Backpacking Trip', slug: 'manali-kasol-amritsar',
    description: 'Hills, Culture & Vibes', heroImage: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?w=800&q=80',
    price: 12999, location: 'Himachal Pradesh', duration: '9 Days / 8 Nights', departureCity: 'Ahmedabad', category: 'Backpacking',
    ...
    travelOptions: [], roomOptions: [], addons: [], status: 'published', createdAt: '', updatedAt: '',
  },
  {
    id: 'mock-2', title: 'Spiti Valley Road Trip', slug: 'spiti-valley-road-trip',
    description: 'High Roads & Higher Vibes', heroImage: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=800&q=80',
    price: 19999, location: 'Himachal Pradesh', duration: '11 Days / 10 Nights', departureCity: 'Chandigarh', category: 'Road Trip',
    images: [], itinerary: [], highlights: [], inclusions: [], exclusions: [], faqs: [],
  ...
  {
    id: 'mock-3', title: 'Winter Spiti Road Trip', slug: 'winter-spiti-road-trip',
    description: 'Snow & Solitude', heroImage: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80',
    price: 19999, location: 'Himachal Pradesh', duration: '10 Days / 9 Nights', departureCity: 'Chandigarh', category: 'Road Trip',
    images: [], itinerary: [], highlights: [], inclusions: [], exclusions: [], faqs: [],
  ...
  {
    id: 'mock-4', title: 'Kerala Backwater Escape', slug: 'kerala-escape',
    description: 'Backwaters, Beaches & Bliss', heroImage: 'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=800&q=80',
    price: 14499, location: 'Kerala', duration: '6 Days / 5 Nights', departureCity: 'Kochi', category: 'Backpacking',
    images: [], itinerary: [], highlights: [], inclusions: [], exclusions: [], faqs: [],
  ...
  {
    id: 'mock-5', title: 'Kerala Trip', slug: 'kerala-trip',
    description: 'Waterfalls, Beaches & Houseboat', heroImage: 'https://images.unsplash.com/photo-1593693411515-c20261bcad6e?w=800&q=80',
    price: 19999, location: 'Kerala', duration: '9 Days / 8 Nights', departureCity: 'Cochin', category: 'Backpacking',
    images: [], itinerary: [], highlights: [], inclusions: [], exclusions: [], faqs: [],
  ...
  {
    id: 'mock-6', title: 'Kedarkantha Trek', slug: 'kedarkantha-trek',
    description: 'Summit Dreams', heroImage: 'https://images.unsplash.com/photo-1605640840605-14ac1855827b?w=800&q=80',
    price: 6499, location: 'Uttarakhand', duration: '6 Days / 5 Nights', departureCity: 'Dehradun', category: 'Trekking',
    images: [], itinerary: [], highlights: [], inclusions: [], exclusions: [], faqs: [],
  ...
  {
    id: 'mock-7', title: 'Leh Ladakh Road Trip', slug: 'leh-ladakh-road-trip',
    description: 'High Passes & Pangong', heroImage: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80',
    price: 15999, location: 'Ladakh', duration: '8 Days / 7 Nights', departureCity: 'Delhi', category: 'Road Trip',
    images: [], itinerary: [], highlights: [], inclusions: [], exclusions: [], faqs: [],
    availableDates: [{ date: '2026-08-10', capacity: 20, bookedCount: 8 }],
    variants: [{ location: 'Delhi', duration: '8 Days / 7 Nights', originalPrice: 18999, discountedPrice: 15999, image: '' }],
    travelOptions: [], roomOptions: [], addons: [], status: 'published', createdAt: '', updatedAt: '',
  },
];
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-xl sm:text-2xl font-black text-[#0B1528] font-montserrat tracking-tight">
          {location} <span className="text-[#D4541A] font-bold">Tour Packages</span>
        </h2>
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 sm:px-10">
          ...
          >
            ...
            <p className="text-zinc-300 text-sm font-semibold max-w-md font-montserrat leading-relaxed">
              Browse curated group trips by destination. Book your next adventure today.
            </p>
          </motion.div>
        </div>
      </section>
