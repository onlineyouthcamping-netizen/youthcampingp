...
function TravellingIcon({ icon }: { icon: string }) {
  switch (icon) {
    ...
    case "bus":
      return <Bus size={20} />;
    case "pickup":
      return <PickupIcon size={20} />;
    case "hotel":
      return <HotelIcon size={20} />;
    default:
...
export default function LuxuryQuotationUI({ q }: { q: Quotation }) {
  ...
  const [selectedHotelForGallery, setSelectedHotelForGallery] =
    useState<any>(null);
  ...
  const handleWhatsAppBooking = () => {
    const message = encodeURIComponent(
      `Hi! I've reviewed the luxury quotation for "${q.tripTitle}". I'd like to confirm the booking for ${q.paxCount || 2} travellers starting from ${getDayDate(q.travelDates?.from, 0) || "the proposed date"}.`,
    );
            ...
            images={
              Array.from(
                new Set([
                  ...
                  ...(q.experiencePhotos || []).map((p: any) =>
                    normalizeImageUrl(typeof p === "string" ? p : p.url),
                  ),
                ]),
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <p className="text-xs font-bold text-slate-400 capitalize tracking-widest leading-none mb-1">
                  {q.customerName}&apos;s
                </p>
                <h2 className="text-2xl font-bold text-[#FF5400] capitalize tracking-tighter">
                  {q.tripTitle}
                </h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {[
                {
                  label: "Duration",
                  val: q.duration || "6 Days & 5 Nights",
                  icon: Clock,
                },
                {
                  label: "Travel Date",
                  val: getDayDate(q.travelDates?.from, 0) || "18 Mar 2026",
                  icon: Calendar,
                },
                {
                  label: "Travellers",
                  val: `${q.paxCount || 2} Adults`,
                  icon: Users,
                },
              ].map((item: any, i: number) => (
                <div
                  key={i}
                  className={`bg-white rounded-[1.5rem] md:rounded-[2rem] border border-slate-100 p-4 md:p-6 flex items-center gap-4 shadow-sm ${i === 2 ? "sm:col-span-2 md:col-span-1" : ""}`}
                >
                  <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 shrink-0">
                    <item.icon size={20} />
                  </div>
                  <div>
                    <p className="text-[9px] md:text-[10px] font-bold text-slate-400 capitalize tracking-widest mb-0.5">
                      {item.label}
                    </p>
                    <p className="text-xs font-bold text-slate-800 capitalize tracking-tight">
                      {item.val}
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 p-6 md:p-10 space-y-10 shadow-sm relative overflow-hidden">
              <h4 className="text-xs font-bold capitalize tracking-[0.3em] text-slate-800">
                Stay & Meals
              </h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-slate-50/50 rounded-2xl md:rounded-3xl p-5 md:p-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-slate-800 capitalize tracking-tight">
                      {q.roomsInfo || "1 Rooms at all location"}
                    </p>
                  </div>
                </div>
                <div className="bg-slate-50/50 rounded-2xl md:rounded-3xl p-5 md:p-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-slate-800 capitalize tracking-tight">
                      {q.mealsInfo || "Breakfast at Property"}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 p-6 md:p-10 space-y-10 shadow-sm">
              ...
              <div className="flex flex-col md:flex-row items-start justify-between relative px-2 gap-6 md:gap-0">
                ...
                {(q.travelling && q.travelling.length > 0
                  ...
                  <div
                    key={i}
                    className="relative z-10 flex flex-row md:flex-col items-center gap-4 md:gap-3 flex-1 text-left md:text-center group w-full md:w-auto"
                  >
            ...
            <div className="space-y-10">
              <div className="flex items-center justify-between">
                <div className="relative">
                  <p className="font-handwritten text-[#FF5400] text-3xl md:text-4xl mb-[-12px] ml-[-10px]">
                    Detailed
                  </p>
                  <h3 className="text-3xl md:text-5xl font-bold text-[#4B5563] tracking-tighter capitalize">
                    Itinerary
                  </h3>
                </div>
                <Button
                      ...
                      <div className="flex items-center gap-3 md:gap-6 shrink-0 border-l border-[#1E3A8A]/10 pl-3 md:pl-6">
                        <div className="hidden sm:flex flex-col gap-1 md:gap-2 min-w-[80px] md:min-w-[120px]">
                          <div className="flex items-center gap-1.5 md:gap-2.5 text-[#4B5563]">
                            <Utensils
                              size={12}
                              className="shrink-0 text-[#1E3A8A]/40"
                            />
                        ...
                        <div className="flex sm:hidden flex-col gap-1">
                          <div className="flex items-center gap-1 text-[8px] font-bold text-[#4B5563]">
                            <Utensils size={10} className="text-[#1E3A8A]/40" />{" "}
                        ...
                        <div
                          className={`transition-transform duration-500 ${expandedDays.includes(day.day) ? "rotate-180 text-[#FF5400]" : "text-[#1E3A8A]/30"}`}
                        >
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="flex overflow-x-auto no-scrollbar gap-6 pb-4">
                                  {day.photos.map((pic: any, pidx: number) => {
                                    ...
                                    const captionText =
                                      parts.slice(1).join("|") ||
                                      `${typeof day.title === "string" ? day.title.split(" ")[0] : "Place"} ${pidx + 1}`;
                                    return (
                                      <div
                                        key={pidx}
                                        onClick={(e) => {
            ...
            <div className="pt-12 space-y-10">
                  ...
                  <button
                    ...
                    className={`px-8 py-2.5 rounded-full text-[10px] font-bold capitalize tracking-widest transition-all flex items-center gap-2 ${
                      selectedTier === "premium"
                        ? "bg-[#FF5400] text-white shadow-lg"
                        : "text-slate-400"
                    }`}
                  >
                    Premium{" "}
                    {selectedTier === "premium" && <CheckCircle2 size={14} />}
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-6">
                {(selectedTier === "premium"
                  ...
                  <div
                    key={i}
                    className="bg-white rounded-[2.5rem] border-2 border-slate-50 hover:border-[#FF5400]/20 transition-all overflow-hidden flex flex-col md:flex-row group/hotel shadow-sm"
                  >
                    <div className="md:w-1/3 aspect-video md:aspect-auto relative overflow-hidden">
                      <img
                        src={normalizeImageUrl(hotel.image)}
                        className="w-full h-full object-cover group-hover/hotel:scale-105 transition-transform duration-700"
                        alt=""
                      />
                      <button
                    ...
                    <div className="flex-1 p-8 md:p-10 space-y-6">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-[10px] font-bold text-slate-400 capitalize tracking-widest ml-2">
                            {hotel.stars || 4} Star Resort
                          </span>
                        </div>
                      </div>
            ...
            <div className="pt-12 space-y-8 md:space-y-10">
              <div className="relative inline-flex flex-col">
                <p className="font-handwritten text-[#FF5400] text-3xl md:text-5xl mb-[-10px] md:mb-[-15px] ml-[-5px] md:ml-[-10px] relative z-10">
                  Places &
                </p>
                <h3 className="text-3xl md:text-6xl font-bold text-[#4B5563] tracking-tighter capitalize relative z-10">
                  Activities
                </h3>
              ...
              <div
                ...
                className="flex overflow-x-auto no-scrollbar gap-4 md:gap-8 pb-8 w-full max-w-full px-1 scroll-smooth snap-x"
              >
                    ...
                    <span className="text-2xl md:text-4xl font-bold text-slate-900 tracking-tighter">
                      ...
                      {(
                        (selectedTier === "premium"
                          ...
                          : q.lowLevelPrice || 32800) - (q.discount || 0)
                      ).toLocaleString()}
                    </span>
                  </div>
            ...
            <div className="pt-12 space-y-10">
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 p-10 space-y-10 shadow-sm">
                <h4 className="text-sm font-bold text-slate-800 capitalize tracking-widest">
                  What&apos;s inside the package?
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-6">
                    <p className="text-[10px] font-bold text-slate-400 capitalize tracking-[0.2em] mb-4">
                      Inclusions
                    </p>
            ...
            <div className="pt-12 space-y-10">
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 p-10 flex flex-col md:flex-row items-center gap-10 shadow-sm relative overflow-hidden">
                ...
                <img
                  src={
                    normalizeImageUrl(q.expert?.photo) ||
                    "https://i.pravatar.cc/150?u=suresh"
                  }
                  className="w-40 h-40 rounded-3xl object-cover ring-8 ring-slate-50 shadow-xl"
                />
                <div className="flex-1 space-y-4">
                  <h4 className="text-xl font-bold text-slate-800 capitalize tracking-widest">
                    {q.expert?.name || "Suresh Chaudhary"}
                  </h4>
                  <p className="text-xs font-bold text-[#FF5400] capitalize tracking-[0.3em]">
                    Destination Expert
                  </p>
                  <p className="text-sm font-medium text-slate-500 leading-relaxed max-w-xl">
                    Experience the true essence of each destination as I uncover
                    its hidden treasures. With my passion for travel and
                    service, I&apos;ll create a tailor-made itinerary that
                    reflects your travel dreams.
                  </p>
                  <div className="flex flex-wrap gap-4 pt-4">
                    <a
                      href={`https://wa.me/${q.expert?.whatsapp?.replace(/\D/g, "")}?text=${encodeURIComponent(`Hi ${q.expert?.name}, I've reviewed the quotation for ${q.tripTitle}. I'd like to discuss further.`)}`}
                      target="_blank"
                      className="flex-1 min-w-[140px]"
                    >
                      <Button
                        variant="outline"
                        className="w-full rounded-xl h-12 px-8 border-slate-200 text-slate-600 font-bold text-xs gap-3"
                      >
            ...
            <div className="pt-12 space-y-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  {
                    t: "Best Experiences",
                    d: "We work with local experts to create high-quality, customized adventures.",
                    icon: "⭐",
                  },
                  {
                    t: "Happy Travellers",
                    d: "Our travellers trust us for exceptional experiences. Check out their reviews.",
                    icon: "😊",
                  },
                  {
                    t: "Personalized Trips",
                    d: "Your trip is designed to match your unique interests and preferences.",
                    icon: "💖",
                  },
                  {
                    t: "24/7 Support",
                    d: "Our team is always here to help, ensuring a smooth journey every step.",
                    icon: "🎧",
                  },
                ].map((item: any, i: number) => (
                  <div key={i} className="space-y-4">
                    <div className="text-3xl">{item.icon}</div>
                    <h5 className="font-bold text-slate-800 capitalize text-xs tracking-widest">
                      {item.t}
                    </h5>
                    <p className="text-[10px] font-medium text-slate-400 leading-relaxed capitalize tracking-tight">
                      {item.d}
                    </p>
                  </div>
                ))}
                  ...
                  : [
                      {
                        ...
                        rating: 5,
                        comment:
                          "Excellent service! The trip was planned perfectly. Every detail was taken care of. Highly recommend!",
                      },
                      {
                        name: "Sagar Patel",
                        rating: 5,
                        comment:
                          "The luxury hotels were amazing. Great experience with YOUTHCAMPING team.",
                      },
                    ]
                ).map((rev, i) => (
                  <div
                    key={i}
                    className="bg-white rounded-[2.5rem] border border-slate-100 p-8 space-y-6 shadow-sm hover:shadow-md transition-shadow"
                  >
            ...
            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden">
              ...
              <div className="relative bg-gradient-to-r from-[#FFF7ED] to-[#FFF7ED] px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 text-[#FF5400]">
                  ...
                  <span className="text-[10px] font-bold capitalize tracking-widest">
                    Save ₹ {q.discount?.toLocaleString() || "6,300"}
                  </span>
                </div>
              ...
              <div className="p-8 pt-10 space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-[10px] font-bold text-slate-300 capitalize mb-1">
                        Your Choice
                      </p>
                    ...
                    <button className="text-[10px] font-bold text-slate-400 capitalize underline decoration-2 underline-offset-4">
                      View More
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-xs font-bold text-slate-800 capitalize">
                    <div className="flex items-center gap-2">
                      ...
                      {getDayDate(q.travelDates?.from, 0) || "18 Mar 2026"}
                    </div>
                    <div className="flex items-center gap-2">
            ...
            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-2xl shadow-slate-200/50 p-8 space-y-6 relative overflow-hidden">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-slate-800">
                  Hey, {q.customerName || "Hemal Patel"} !
                </h3>
                <p className="text-sm font-medium text-slate-500 leading-relaxed">
                  Connect with me if you got any questions regarding this
                  package.
                </p>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold capitalize text-slate-400 tracking-widest">
                    Destination Expert
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <Button
                    variant="outline"
                    className="w-full rounded-xl h-12 border-slate-200 text-slate-600 font-bold text-xs gap-2"
                  >
      ...
      <footer className="bg-slate-900 text-white py-20 mt-20 relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold mb-8 tracking-tighter capitalize leading-none">
            Ready for your <br />{" "}
            <span className="text-[#FF5400] italic font-serif">
              Legendary Trip?
            </span>
          </h2>
              ...
              <div className="container mx-auto px-8 py-20 max-w-5xl">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                  <div className="md:col-span-2 space-y-12">
                    <div className="space-y-4">
                      <h4 className="text-xs font-bold capitalize tracking-[0.4em] text-white/40">
                        The Experience
                      </h4>
                  ...
                  <div className="space-y-12">
                    <div className="p-8 bg-white/5 border border-white/10 rounded-3xl space-y-6">
                      <h4 className="text-xs font-bold capitalize tracking-widest text-[#FF5400]">
                        Key Highlights
                      </h4>
                      <ul className="space-y-4">
                        {[
                          ...
                          "Premium Photo Op",
                          "Entry Passes Pre-booked",
                        ].map((h, i) => (
                          <li
                            key={i}
                            className="flex items-center gap-3 text-white/70 text-sm font-bold"
                          >
                            <CheckCircle2
                              size={16}
            ...
            >
              <div className="p-8 md:p-12 space-y-10">
                ...
                <div className="flex items-start justify-between gap-6">
                  <div className="space-y-4 flex-1">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs font-bold text-[#FF5400] capitalize tracking-widest">
                        {selectedHotelForGallery.roomType || "Superior Room"}
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  selectedHotelForGallery.photos.length > 0
                    ? selectedHotelForGallery.photos
