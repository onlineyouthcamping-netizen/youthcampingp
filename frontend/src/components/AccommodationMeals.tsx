...
const STAYS = [
  {
    ...
    icon: Hotel,
    tag: "Comfort",
    features: ["Centrally located", "Attached washrooms", "Room service"],
  },
  {
    location: "Chitkul",
    type: "Cottage",
    icon: Home,
    tag: "Raw Experience",
    features: ["River view", "Wooden interiors", "Last village vibe"],
  },
  {
    location: "Tabo",
    type: "Homestay",
    icon: Home,
    tag: "Authentic",
    features: ["Local host", "Cultural insight", "Traditional meals"],
  },
  {
    location: "Kaza",
    type: "Homestay",
    icon: Home,
    tag: "Comfort",
    features: ["Modern amenities", "Cozy bedding", "Near main market"],
  },
  {
    location: "Chandratal",
    type: "Camp",
    icon: Tent,
    tag: "Raw Experience",
    features: ["Luxury tents", "Stargazing", "Near Moon Lake"],
  },
  {
    location: "Manali",
    type: "Hotel",
    icon: Hotel,
    tag: "Comfort",
    features: ["Balcony rooms", "Hot water", "Mountain view"],
  },
];
      ...
      <section className="bg-zinc-950 rounded-[40px] p-10 md:p-16 text-white overflow-hidden relative">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              <h4 className="text-primary-orange font-semibold uppercase tracking-wide text-xs mb-6">
                Breakfast Menu
              </h4>
              <p className="text-white/60 font-normal leading-relaxed italic">
                Start your day with Hot Parathas, Poha, Sandwich, Omelettes,
                Bread-Jam, and local Himalayan Tea.
              </p>
            </div>
            <div>
              <h4 className="text-primary-orange font-semibold uppercase tracking-wide text-xs mb-6">
              ...
              <p className="text-white/60 font-normal leading-relaxed italic">
                A hearty spread featuring Paneer/Chicken Sabzi, Dal Tadka,
                Seasonal Veggies, Jeera Rice, Chapati, and a Sweet dish.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 pt-10 border-t border-white/5 flex items-center gap-4">
            ...
            <p className="font-semibold text-white/80">
              Important: Lunch is not included to allow exploration of local
              cafes.
            </p>
          </div>
        </div>
