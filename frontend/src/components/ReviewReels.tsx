    ...
    <section className="overflow-hidden">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <h2 className="text-2xl font-bold text-navy">
          Traveller{" "}
          <span className="text-[#D4541A] font-caveat italic">Videos</span>
        </h2>
      ...
      <div className="flex gap-6 overflow-x-auto pb-8 no-scrollbar snap-x">
        {reels.map((reel, i) => (
          ...
          >
            <OptimizedImage
              src={
                normalizeImageUrl(reel.thumbnail) ||
      ...
      <AnimatePresence>
        {activeReel && (
          ...
          >
            ...
            >
              {activeReel.url.includes("youtube.com") ||
              activeReel.url.includes("youtu.be") ? (
                <iframe
