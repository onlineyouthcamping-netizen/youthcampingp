              ...
              <div className="flex flex-col md:flex-row gap-12">
                ...
                <div className="flex-1 space-y-8">
                  ...
                  <div className="flex items-center gap-6 p-6 bg-zinc-50 rounded-[32px] border border-zinc-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[10px] font-bold capitalize text-zinc-400 tracking-widest">
                          Authored By
                        </p>
                ...
                <div className="w-full md:w-64 space-y-8">
                  <div className="p-8 bg-navy text-white rounded-[40px] shadow-xl space-y-6">
                    <p className="text-[10px] font-bold capitalize tracking-widest opacity-60">
                      Share Adventure
                    </p>
                  ...
                  <div className="p-8 bg-primary/5 border-2 border-primary/10 rounded-[40px] space-y-4">
                    <h4 className="font-bold text-navy capitalize text-sm tracking-tight leading-none">
                      Ready for your own story?
                    </h4>
                    <p className="text-[11px] text-zinc-500 font-bold leading-relaxed">
                      Book a trip today and start your own adventure in the
                      Himalayas.
                    </p>
