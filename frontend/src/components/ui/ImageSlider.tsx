...
export const ImageSlider = ({
  ...
  if (!images || images.length === 0) {
    return (
      <div
        className={cn(
          "w-full bg-slate-50 flex items-center justify-center rounded-2xl min-h-[300px] border border-slate-100",
          className,
        )}
      >
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="text-slate-400 font-bold capitalize tracking-widest text-[10px]">
            Visuals being prepared
          </span>
        </div>
      </div>
    );
