...
const PREDEFINED_QUOTES: Record<string, any> = {
  "kashmir-parth": {
    ...
    advancePayment: 5000,
    heroImage:
      "https://images.unsplash.com/photo-1598330094281-0552768e62c1?q=80&w=2000",
    overview:
      "Experience the timeless beauty of Kashmir. From the serene Dal Lake houseboats to the snow-capped meadows of Gulmarg, this 4-day curated journey is designed for those who seek the perfect blend of luxury and natural wonder.",
    ...
    itinerary: [
      {
        ...
        description:
          "Arrive in Srinagar and check into your luxury carved Cedar-wood houseboat. In the evening, enjoy a 90-minute private Shikara ride through the floating gardens as the sun sets behind the Zabarwan range.",
        photos: [
          "https://images.unsplash.com/photo-1566833925222-792012999b42?q=80&w=1000",
        ],
      },
      {
        day: 2,
        ...
        description:
          "Travel to Gulmarg. Take the world's second-highest cable car, the Gondola, up to Phase 2 (13,780 ft) for breathtaking views of Mt. Apharwat. Afternoon walk through the lush green golf courses.",
        photos: [
          "https://images.unsplash.com/photo-1621644788174-89745e998782?q=80&w=1000",
        ],
      },
      {
        day: 3,
        ...
        description:
          "Drive to Pahalgam, the 'Valley of Shepherds'. Visit the famous Saffron fields en route. Relax by the Lidder River or take a pony ride to the stunning Baisaran Valley (Mini Switzerland).",
        photos: [
          "https://images.unsplash.com/photo-1598330094281-0552768e62c1?q=80&w=1000",
        ],
      },
      {
        day: 4,
        ...
        description:
          "After a traditional Kashmiri breakfast, visit the Mughal Gardens (Nishat & Shalimar) before departing for the airport with memories of a lifetime.",
        photos: [
          "https://images.unsplash.com/photo-1591389067442-a25a21d3399b?q=80&w=1000",
        ],
      },
    ],
    lowLevelHotels: [
      {
        ...
        stars: 4,
        image:
          "https://images.unsplash.com/photo-1566833925222-792012999b42?q=80&w=800",
        description:
          "Authentic hand-carved cedar wood houseboat with modern amenities.",
    ...
    highLevelHotels: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=800",
        description:
          "The crown jewel of Gulmarg. World-class luxury with heated pools and floor-to-ceiling mountain views.",
      ...
      },
      {
        ...
        description:
          "Perched on a hill overlooking the Dal Lake, offering the most iconic sunrise views in the valley.",
        amenities: ["360 View", "Fitness Center", "Gourmet Kitchen"],
      },
    ],
    inclusions: [
      "Luxury Accommodations",
      "Private A/C SUV Transfers",
